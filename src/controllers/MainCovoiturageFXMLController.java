...
public class MainCovoiturageFXMLController implements Initializable {
    ...
    StackPane listeCovoiturage;
    AnchorPane        mesCovoituarge;
    ...
    @FXML
    private void goToListCovoiturage(ActionEvent event) {
    }

    @FXML
    private void GoToMesCovoiturage(ActionEvent event) {
    }
